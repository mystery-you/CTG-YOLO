...
class Triple_C2f(nn.Module):
    def __init__(self, c1, c2, e = 2):
        super().__init__()
        c_ = int(c1 * e)
        self.c1 = Conv(c1, c_, 1, 1)
        self.c2 = Conv(c_, c2)
        # self.c3 = StarNetBlock(c_)
        self.c3 = ConvNextBlock(c_)
        self.c4 = Conv((c_ + c2), c2, 1, 1)
...
if __name__ == '__main__':
    ...
    model = Triple_C2f(256,256)  # 创建 ScConv 模型
